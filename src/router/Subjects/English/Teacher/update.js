...
const Validate_update_question = require("../../../../middleware/joi_validation/Subjects/Teacher/Joi_validate_update_question");
...
router.put("/" , upload_question_images , async (req , res , next) => {
    try {
        ...
        // check if the teacher is teacher
        ...
        const updateQuestion = await English.findByIdAndUpdate({ _id : req.body.question_id }, {
            $set : {
        ...
        const result = {
            ...
            "question_data" : _.pick(updateQuestion , ["_id" , "title" , "description" , "note" , "points" , "level" , "class_level" , "images" , "repated" , "options" , "created_by"])
        }
