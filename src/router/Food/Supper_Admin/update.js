...
router.put("/", upload_food_images, async (req, res, next) => {
  try {
    ...
    // craete the new images for delete and check if the request any images for delete
    ...
    if (!isAdmin) {
      ...
      return next(
        new ApiErrors(
          JSON.stringify({
            english:
              "Sorry, you don't have permissions to update food meal ...",
