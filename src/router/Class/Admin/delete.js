...
const Validate_class_delete = require("../../../middleware/joi_validation/Admin/Class/Joi_validate_delete_class");
...
router.delete("/", async (req, res, next) => {
  try {
    ...
    if (!isAdmin) {
      ...
      return next(
        new ApiErrors(
          JSON.stringify({
            english:
              "Sorry, you don't have permissions to create parent account ...",
    ...
    const teacher = await Teacher.findById(classObject.teacher._id);
