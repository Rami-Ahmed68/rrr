...
const Validate_hw_create = require("../../../middleware/joi_validation/super_Admin/Home work/Joi_validate_create_hw");
...
router.post("/", upload_home_work_images, async (req, res, next) => {
  try {
    ...
    if (!isSuperAdmin) {
      ...
      return next(
        new ApiErrors(
          JSON.stringify({
            english:
              "Sorry, you don't have permissions to create home work ...",
    ...
    const result = {
      ...
      home_work_data: _.pick(homeWork, [
        "_id",
        "title",
        "description",
        "note",
